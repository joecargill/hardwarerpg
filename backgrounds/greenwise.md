...
- Iron Pot
- Root Knife (d6)
- Healing Salve (restore 1d4 BOD, 1 use)
...
| **6** | You created a restorative tincture that also causes accidental infertility. Take a **Healing Potion** that completely restores BOD. Only you know of its unintended side-effects.                       |
...
| **6** | **Briarvine**    | Entangles any creature up to horse size (BOD to break free). Reusable.                                   |
