...
- Heartroot Salve (restores 1d4 BOD, 1 use)
...
| **2** | **Falconry**. You keep a falcon [3 hp, 5 BOD, 16 AGL, 4 CTR, claws (d6+d6), bite (d8)]. It only eats live game.                                                                                             |
...
| **5** | **Training**. If you are the first to attack, melee attacks against you are _impaired_ until you take BOD damage.                                                                                           |
