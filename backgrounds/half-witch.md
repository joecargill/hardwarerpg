...
- Iron Dagger (d6)
- Herbs Pouch (restore 1 BOD, 3 uses)
- Ghillie Suit
...
| **3** | A **Living Nightmare** that dwells within you but manifests whenever you are in danger. It has your same **Attributes** and **STA** and attacks with claws (d8+d8). It disappears on **Critical Damage** (take 1d4 CTR damage), re-appearing again on the next full moon. |
| **4** | A **Raven Familiar** [8 STA, 3 BOD, 11 AGL, 13 CTR, beak, (d6)]. It speaks as an intelligent being and is entirely devoted to you.                                                                                                                             |
