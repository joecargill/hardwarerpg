...
| **4** | Both **ears** have been surgically enhanced, tripling your hearing. You can focus on a specific sound, such as a conversation, at a great distance. You wear an ear flap to protect against sudden loud noises (CTR save to avoid temporary paralysis). |
...
| **3** | **Woundwax**       | Heals wounds from fire or chemicals (restoring full BOD) but nothing else. 2 uses.                                                                               |
| **4** | **Quicksilver**    | A stimulant. Go first in combat, and automatically pass any CTR saves for one hour. _Addictive_: Save BOD or become _deprived_ after 24 hours without it. 4 uses. |
