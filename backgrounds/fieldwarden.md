...
| **5** | Wolves, or so you thought. You are now a **Werewolf** [8 STA, 15 BOD, 14 AGL, claws (d6+d6), bite (d8)]. Your CTR remains the same. You can _turn_ at will (once per day) but must make a CTR save to revert. Anyone left alive from your attacks must make a CTR save to avoid infection. |
| **6** | Crop thieves. Not all of them survived, but you were outnumbered. Start with +d4 STA and a **Cusped Falchion** (d8).  |
...
| **6** | **Everbloom Band** | A circlet adorned with flowers that never wilt. On **Critical Damage**, the flowers dissolve into dust, but you act as if your save succeeded (BOD loss still occurs). |
