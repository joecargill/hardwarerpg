...
Sometimes a situation or circumstance may influence the difficulty of succeeding, affecting a PCs chance of success. In these cases, the Admin may ask you to roll with **Advantage** or **Disadvantage**. 
...
Roll 1d6 to determine your PC's starting **Stamina**, which reflects their ability to avoid damage and endure stress. It does not indicate a character’s health or fortitude, nor do they lose it for very long. See [Healing & Recovery](/playtest/core-rules#healing--recovery).
...
A PC that lacks a crucial need (such as food or rest) is **Deprived**. Anyone *Deprived* for more than a day adds **Fatigue** to their inventory, one for each day. A **Deprived** PC cannot recover Stamina, Attributes, or item slots from *Fatigue*.
...
To create a contractor, choose an appropriate role from the [Contractors](/playtest/marketplace/services/#contractors) table in the Marketplace. Roll 3d6 for each attribute and 1d6 for their Stamina. Give them **equipment** appropriate to their station, then roll on the Character Traits tables to further flesh them out.
