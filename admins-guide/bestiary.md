...
4 STA, 1 Armor, 8 BOD, 11 AGL, 14 CTR, ceremonial dagger (d6)
...
6 STA, 13 BOD, 12 AGL, 15 CTR, bite (d8)
...
4 STA, 1 Armor, 12 BOD, 12 AGL, 9 CTR, short sword (d6) or short bow (d6)
...
- **Loyal**: When testing Morale, save using the leader's CTR (13). If the leader dies, the others will flee.

## Banshee

8 STA, 6 BOD, 12 AGL, 15 CTR, ghostly touch (d8)
...
- **Wail**: Anyone in earshot must make a CTR save or fall unconscious.

## Basilisk

10 STA, 1 Armor, 12 BOD, 13 AGL, 13 CTR, bite (d10)
...
5 STA, 11 BOD, 14 AGL, 5 CTR, bite (d6)
...
4 STA, 12 BOD, 13 AGL, 5 CTR, horns (d8)
...
8 STA, 3 Armor, 15 BOD, 5 AGL, 3 CTR, sharpened arms (d8+d8), _detachment_
...
8 STA, 1 Armor, 14 BOD, 12 AGL, 11 CTR, club (d8)
...
6 STA, 1 Armor, 16 BOD, 11 AGL, 4 CTR, bite (d10), acid squirt (d8, _blast_)
...
2 STA, 6 BOD, 12 AGL, 3 CTR, bite (d6)
...
6 STA, 1 Armor, 14 BOD, 12 AGL, 14 CTR, spear (d8) or short bow (d6)
...
12 STA, 2 Armor, 14 BOD, 1 AGL, 8 CTR, bite (d10)
...
8 STA, 10 BOD, 12 AGL, 2 CTR, vines (d4, _blast_)
...
12 STA, 12 BOD, 11 AGL, 14 CTR, ethereal claws (d8+d8)
...
4 STA, 8 BOD, 12 AGL, 14 CTR, knotted arms (d6)
...
- **Befuddle**: Target becomes confused, gradually moving further and further away from the host tree. CTR save once per round to break free.

## Ettin

10 STA, 16 BOD, 8 AGL, 6 CTR, club (d10)
...
15 STA, 9 BOD, 8 AGL, 16 CTR, bite (d8)
...
- Can cast the following spells at will: _Charm, Phobia, Telekinesis, Sleep, Shuffle, Vision_. Magic used against them requires a CTR save or it fizzles out.

## Frost Elf

14 STA, 1 Armor, 8 BOD, 13 AGL, 14 CTR, icicle dagger (d6)
...
8 STA, 3 Armor, 14 BOD, 4 AGL, 12 CTR, claws (d8+d8)
...
8 STA, 1 Armor, 15 BOD, 6 AGL, 3 CTR, devouring touch (d8)

- Large shapeless masses of transparent jelly. Mindlessly hunt for food in dungeons and underground caverns.
- **Critical Damage**: The target is engulfed, losing d6 BOD damage per round until they are consumed.

## Ghost

8 STA, 14 BOD, 12 AGL, 15 CTR, life drain (d6)

- Incorporeal spirits of the restless dead, vulnerable only to magic and specific anointed rites.
- **Critical Damage**: Target must save CTR or is possessed, acting only on behalf of the ghost's whims.

## Ghoul

6 STA, 14 BOD, 8 AGL, 3 CTR, elongated claws (d6+d6)
...
8 STA, 1 Armor, 11 BOD, 12 AGL, 4 CTR, claws (d10+d10)

- Horse-sized arachnids commonly found in dry terrain or caverns.
- **Critical Damage**: The stinger's poison liquefies the target's insides for an additional d8 BOD damage. The BOD loss is permanent.

## Gnoll

6 STA, 1 Armor, 12 BOD, 14 AGL, 8 CTR, spear (d8)
...
4 STA, 8 BOD, 12 AGL, 8 CTR, dagger (d6) or sling (d6)
...
12 STA, 2 Armor, 14 BOD, 15 AGL, 18 CTR, bite (d12), _detachment_
...
- **Chlorine Gas**: Anyone nearby must make a AGL save to escape its reach or lose 1d4 BOD and becomes _deprived_.

## Griffon

7 STA, 14 BOD, 15 AGL, 12 CTR, claws (d6+d6), _detachment_
...
6 STA, 15 BOD, 13 AGL, 5 CTR, claws (d8+d8)
...
- **Critical Damage**: Bites the victim for an additional d6 BOD damage. They bleed out very quickly.

## Harpy

8 STA, 7 BOD, 12 AGL, 14 CTR, claws (d6+d6)
...
- **Song**: Anyone nearby must save CTR or be charmed by its voice, following the harpy and defending it from any threat.

## Hellhound

8 STA, 12 BOD, 15 AGL, 9 CTR, bite (d8), fire breath (d6, _blast_)
...
6 STA, 2 Armor, 14 BOD, 8 AGL, 11 CTR, mace (d8)
...
12 STA, 9 BOD, 12 AGL, 14 CTR, leystaff (d8)

- The Watchers of the Wood; a cult that derive their power from leylines, rune stones, and the like.
- **Critical Damage**: Leech a part of the victim's soul (1d4 CTR damage).
- Carries two of the following spellbooks: _Charm, Hypnotize, Push/Pull, Shield_.

## Hydra

12 STA, 2 Armor, 13 BOD, 7 AGL, 12 CTR, bite (d12, _blast_), _detachment_
...
8 STA, 12 BOD, 12 AGL, 15 CTR, fists (d4+d4)

- Intelligent beings shaped into reality by a powerful wizard. Completely invisible and silent.
- Attacks deal direct BOD damage (subtracting Armor).

## Killer Bees

6 STA, 6 BOD, 14 AGL, 8 CTR, sting (d6), _detachment_

- Oversized bees that build underground hives. Hyper-aggressive, attack anything that comes near.
- Produce special honey that heals 1d6 BOD. 3 uses.
- When the bees cause BOD damage, the stingers are lodged into the target, dealing d4 damage each round until removed.

## Kobold

3 STA, 8 BOD, 13 AGL, 4 CTR, bite (d6), spear (d8)
...
6 STA, 11 BOD, 12 AGL, 16 CTR, toothy bite (d8)
...
- **Critical Damage**: The target takes d6 CTR damage as their spirit is slowly sapped away. They then become enthralled to the Lamia, obeying its every command while in its presence.

## Lich

14 STA, 1 Armor, 8 BOD, 8 AGL, 18 CTR, soul dagger (d8)
...
6 STA, 15 BOD, 14 AGL, 12 CTR, claws (d6+d6), tail spike (d8)
...
9 STA, 2 Armor, 13 BOD, 6 AGL, 12 CTR, bite (d8)
...
12 STA, 8 BOD, 12 AGL, 18 CTR, tentacles (d6, _blast_)
...
- **Mind Blast**: Nearby targets must save CTR or lose 1d4 CTR and become paralyzed.
- **Critical Damage**: A tentacle rips the victim's brain out of their skull.

## Minotaur

12 STA, 1 Armor, 16 BOD, 12 AGL, 8 CTR, two-handed axe (d10), charge (d12)
...
6 STA, 12 BOD, 8 AGL, 6 CTR, necrotic touch (d10)

- Undead humanoids wrapped in funerary cloth. Found in pyramids, ruins, temples, and tombs.
- **Critical Damage**: Target is infected with mummy rot, and is unable to recover BOD until they are cured by a specialist healer. The target is also _deprived_.

## Naga

6 STA, 1 Armor, 14 BOD, 12 AGL, 14 CTR, sword (d6), bite (d10)
...
6 STA, 9 BOD, 14 AGL, 5 CTR, claws (d6+d6)

- Intelligent, nocturnal marsupials that make their homes in forests and swamps. Hunt in
packs.
- Critical Damage: The Night Cat begins to eat the target (d4 BOD damage) while they are
still alive.

## Night Hag

8 STA, 9 BOD, 11 AGL, 16 CTR, talons (d8+d8)
...
8 STA, 15 BOD, 12 AGL, 8 CTR, flaming hooves (d8+d8)
...
6 STA, 1 Armor, 16 BOD, 8 AGL, 6 CTR, club (d10)
...
9 STA, 16 BOD, 12 AGL, 5 CTR, beak (d10), claws (d8+d8)
...
4 STA, 15 BOD, 13 AGL, 12 CTR, talons (d10+d10)
...
18 STA, 1 Armor, 18 BOD, 8 AGL, 6 CTR, bite (d12), _detachment_
...
- **Critical Damage**: The target is devoured, taking d8 BOD damage from the acid in the worm's stomach.

## Red Cap

6 STA, 6 BOD, 12 AGL, 8 CTR, dual sickles (d6+d6)
...
- **Critical Damage**: Target is eviscerated, the spray of their blood restoring BOD loss suffered by the Red Cap.

## Reptilian

5 STA, 1 Armor, 14 BOD, 12 AGL, 5 CTR, bone spear (d8)
...
4 STA, 8 BOD, 14 AGL, 8 CTR, spear (d6)
...
8 STA, 9 BOD, 16 AGL, 14 CTR, tuber-fingers (d6)
...
5 STA, 16 BOD, 13 AGL, 5 CTR, bite (d6)
...
6 STA, 11 BOD, 15 AGL, 14 CTR, long claws (d6+d6)

- Ghostly, green-skinned hags that dwell in seaweed forests and warm shallow waters.
- Immune to magic from spellbooks. 
- **Hideous Gaze**: A target is overcome with fear (STA drops to 0). CTR save each round to break the spell.

## Shadow

14 STA, 1 BOD, 18 AGL, 14 CTR, draining touch (d6, ignores armor) 

- Incorporeal monsters that look like animated shadows. Unharmed by mundane attacks, sleep or mind control.
- **Critical Damage**: Target loses d4 BOD. If reduced to 0 BOD, they become a shadow as well.

## Shambling Mound

9 STA, 15 BOD, 6 AGL, 8 CTR, tendrils (d8+d8), _detachment_
...
5 STA, 1 Armor, 8 BOD, 13 AGL, 0 CTR, rusty sword (d6) or bow (d6)
...
12 STA, 1 Armor, 16 BOD, 12 AGL, 14 CTR, mace (d10), _detachment_
...
18 STA, 12 BOD, 13 AGL, 18 CTR, claws (d8+d8, _blast_), beak (d10)
...
- **Roar**: Anyone in earshot must save CTR or flee in fear.

## Storm Giant

18 STA, 2 Armor, 18 BOD, 16 AGL, 18 CTR, great sword (d12), _detachment_
...
- **Thunderclap**: Deals 4 BOD damage against a single target. Targets wearing metal armor take double damage.

## Swine Thing

9 STA, 16 BOD, 8 AGL, 13 CTR, gore (d6+d6)
...
- **Charm**: Target obeys the swine's every command until it is killed. CTR save once per round to break free.

## Titan

18 STA, 3 Armor, 16 BOD, 15 AGL, 18 CTR, lightning sword (d12), _detachment_
...
10 STA, 3 Armor, 15 BOD, 3 AGL, 12 CTR, roots (d8+d8, _blast_)
...
6 STA, 12 BOD, 15 AGL, 12 CTR, trident (d8)
...
14 STA, 1 Armor, 14 BOD, 12 AGL, 4 CTR, bite (d10), claws (d8+d8)
...
- When taking **Critical Damage**, a Troll will continue fighting, despite loss of flesh and limb. Only when their BOD is 0 are they truly killed. Unless their heads are bathed in acid, fire, or powerful magic, they will fully regenerate within 1d4 days.

## Unicorn

6 STA, 14 BOD, 12 AGL, 14 CTR, horn (d10, ignores armor)
...
12 STA, 1 Armor, 14 BOD, 12 AGL, 16 CTR, bite (d10)
...
- **Regeneration**: A damaged vampire regains 6 STA when it bites a target that has blood. If killed, it becomes a cloud of gas and retreats to its coffin, reforming at the next nightfall. Can only be killed if exposed to sunlight or if the coffin is destroyed.
- **Critical Damage**: The vampire drains the target's essence, dealing d12 damage to CTR. If the target reaches 0 CTR this way, it dies and is raised as a thrall of the vampire.

## Viper

3 STA, 5 BOD, 12 AGL, 3 CTR, bite (d6)
...
8 STA, 13 BOD, 16 AGL, 12 CTR, tentacles (d8+d8, _blast_), bite (d10)

- Grotesque panther-like predators with long razored tentacles growing out of their backs.
- Resistant to magical attacks. Caster must make a CTR save for the intended effect to succeed.
- Can teleport a short distance away at will. Hate Blink Dogs.

## Warrior Snail

4 STA, 2 Armor, 14 BOD, 6 AGL, 3 CTR, tentacles (d8+d8)
...
14 STA, 15 BOD, 16 AGL, 4 CTR, spray (d8)
...
8 STA, 15 BOD, 14 AGL, 6 CTR, claws (d6+d6), bite (d8)
...
12 STA, 3 Armor, 16 BOD, 8 AGL, 12 CTR, long sword (d10)
...
- **Critical Damage**: On a fail, any BOD loss is permanent.

## Will-o-Wisp

3 STA, 6 BOD, 17 AGL, 12 CTR
...
6 STA, 12 BOD, 14 AGL, 8 CTR, bite (d8)
...
10 STA, 15 BOD, 12 AGL, 7 CTR, bite (d8), club (d10)
...
11 STA, 15 BOD, 14 AGL, 13 CTR, stinger (d10)
...
2 STA, 12 BOD, 6 AGL, 3 CTR, jagged nails (d6)
