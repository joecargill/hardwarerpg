...
- **Sconce**: Passing beneath the flames releases a poison gas spray into the room, dealing d4 BOD damage to anyone nearby (save to avoid losing consciousness).
...
5 STA, 11 BOD, 12 AGL, 8 CTR, petrified short sword (d8)
...
- **Pillars**: Built from floor to ceiling and made of petrified wood. 
  ...
  - If two _adjacent_ pillars are destroyed, the room will collapse on its occupants (AGL save or take 12 BOD damage).
...
- **Holes**: Created by a _Burrowing Horror_. 
  - If the party ignores the ceiling, it attacks the first PC that walks under a hole (ignore STA).
...
- **Mirror**: If moved to the North wall, the reflection will reveal a small, invisible alcove on the South side.
  ...
  - If damaged, the mirror will explode (d6 BOD damage to any nearby). The victim is _deprived_, and their cuts do not heal until they have left the temple.
