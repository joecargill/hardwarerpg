...
- **Bees**: Their buzzing is nearly deafening, creating a wall of sound around the tree.
  ...
  - Any attempt to take honey from the hive is met with an aggressive response from the colony [3 STA, 3 BOD, 12 AGL, 4 CTR, sting (d6), _detachment_].
