...
- Horatia Confi, first of her order. Recovered the _Map of the Dead_ for the _Guild_. CTR 15.  
...
- The **Admin** should rely on the fiction to determine whether a faction is positioned to advance their agenda. 
...
- If two factions are _opposed_, the faction _most at risk_ makes a CTR save, using the score of its highest-ranking agent. On a fail, the faction does not roll on the Faction Actions table at this time.
...
> See the [Dungeon Seeds](/wip/admins-guide/dungeon-seeds) chapter for how to flesh out each Dungeon POI for your setting.
