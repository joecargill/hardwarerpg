...
- If the party attempts to step off the trail and cut through the forest, the Admin should make any associated costs clear: added travel time, effort, special tools that may be required, and any obvious dangers. Going off-trail also automatically triggers a roll on the Wilderness Events table.
...
- **Flora**: Rare and unique species not common to these parts.
  - Skilled pruning and a few minutes of careful work produces a **Healing Salve** (restore 1d4 BOD, 1 use).
...
12 STA, 2 Armor, 13 BOD, 15 AGL, 17 CTR, yew bow (d8)
...
- **Critical Damage**: Bite the targeting for an additional d6 BOD damage. The target bleeds out very quickly.
...
4 STA, 12 BOD, 5 AGL, 6 CTR, tusks (d6+d6)

#### **Black Silk Spider**

4 STA, 4 BOD, 13 AGL, 5 CTR, bite (d8)
